...
(self.webpackChunkgns3_web_ui = self.webpackChunkgns3_web_ui || []).push([
  [26],
  {
    91026: function (W, g, a) {
      ...
      function b(i, e) {
        1 & i && (t.O4$(), t.TgZ(0, "svg", 28), t._UZ(1, "rect", 29), t.qZA());
      }
      function E(i, e) {
        1 & i && (t.O4$(), t.TgZ(0, "svg", 28), t._UZ(1, "rect", 30), t.qZA());
      }
      function Z(i, e) {
        1 & i && (t.O4$(), t.TgZ(0, "svg", 28), t._UZ(1, "rect", 31), t.qZA());
      }
      function O(i, e) {
      ...
      function M(i, e) {
        if (
          (1 & i &&
            (t.TgZ(0, "div", 25),
            t.TgZ(1, "div"),
            t.YNc(2, b, 2, 0, "svg", 26),
            t.YNc(3, E, 2, 0, "svg", 26),
            t.YNc(4, Z, 2, 0, "svg", 26),
            t._uU(5),
            t.qZA(),
            t.YNc(6, O, 2, 3, "div", 27),
            t.YNc(7, P, 2, 0, "div", 27),
            t.qZA()),
          2 & i)
        ) {
          var o = e.$implicit;
      ...
      function F(i, e) {
        if (
          (1 & i &&
            (t.TgZ(0, "div", 25),
            t.TgZ(1, "div"),
            t.YNc(2, w, 2, 0, "svg", 26),
            t.YNc(3, A, 2, 0, "svg", 26),
            t._uU(4),
            t.qZA(),
            t.TgZ(5, "div"),
            t._uU(6),
      ...
      function N(i, e) {
        if (1 & i) {
          ...
          (t.TgZ(0, "div", 3),
            ...
            t.TgZ(26, "div", 21),
            t.YNc(27, M, 8, 6, "div", 22),
            t.qZA(),
            t.qZA(),
            t.qZA(),
            t.TgZ(28, "mat-tab", 23),
            t.NdJ("click", function () {
              return (t.CHM(o), t.oxw().toggleTopologyVisibility(!1));
            }),
            t.TgZ(29, "div", 6),
            t.TgZ(30, "div", 24),
            t.YNc(31, F, 9, 5, "div", 22),
            t.qZA(),
            t.qZA(),
            t.qZA(),
            t.qZA(),
        ...
        if (2 & i) {
          ...
          (t.Q6J("ngStyle", s.style)(
            "ngClass",
            t.VKq(9, I, s.isLightThemeEnabled),
          )("validateResize", s.validate)("resizeEdges", t.DdM(11, D))(
            "enableGhostResize",
            !0,
          ),
            t.xp6(20),
            ...
            t.xp6(4),
            t.Q6J("ngForOf", s.computes));
        }
      }
      var U = (function () {
        function i(e, o, s, r, n) {
        ...
        return (
          ...
          (i.prototype.dragWidget = function (e) {
            ...
            if (this.style.left) {
              var u = Number(this.style.left.split("px")[0]) + o;
              ((this.style = {
                position: "fixed",
                left: u + "px",
                top: l + "px",
                ...
                localStorage.setItem("leftPosition", u.toString()),
              ...
              var m = Number(this.style.right.split("px")[0]) - o;
              ((this.style = {
                position: "fixed",
                right: m + "px",
                top: l + "px",
                ...
                localStorage.setItem("rightPosition", m.toString()),
                localStorage.setItem("topPosition", l.toString()),
                localStorage.setItem("widthOfWidget", r.toString()),
                localStorage.setItem("heightOfWidget", n.toString()));
            }
          ...
          (i.ɵcmp = t.Xpm({
            ...
            template: function (o, s) {
              (1 & o &&
                (t.YNc(0, C, 1, 0, "div", 0), t.YNc(1, N, 32, 12, "div", 1)),
                2 & o &&
